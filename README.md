...
<p align="center">
  ...
  <img src="images_read_me/result_api2.PNG" width="250" height="250">
</p>
...
**If you select to run locally, set the variable process in the flask_app.py to 'local'**. Run the flask_app.py file using python > 3.8.10 and on your web browser enter your local host (usually http://127.0.0.1:5000/) wait until the page load and follow the instructions shown. The exam will be processed locally and the output will be saved in the outputs folder in a json file as well as be shown as result on the FLASK API
